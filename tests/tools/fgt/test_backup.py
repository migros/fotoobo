...
def test_backup_no_backup_dir(monkeypatch: MonkeyPatch, temp_dir: str) -> None:
    ...
    monkeypatch.setattr("fotoobo.tools.fgt.main.config.inventory_file", "tests/data/inventory.yaml")
    ...
    monkeypatch.setattr("fotoobo.tools.fgt.main.os.path.isfile", MagicMock(return_value=True))
