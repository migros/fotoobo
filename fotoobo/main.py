...
a traceback. The traceback is written to a traceback.txt file in the local directory for debug
purposes.
...
def main() -> None:
    ...
    try:
        ...
        print("oops, something did not work as expected. See traceback.txt for more info")
        with open("traceback.txt", "w", encoding="UTF-8") as exc_file:
